...
public class VitruvianRamseteCommand extends RamseteCommand {
    ...
    public void execute() {
        super.execute();
        SmartDashboard.putNumber(" DriveTrain Velocity", Units.metersToFeet(m_driveTrain.getDriveTrainKinematics().toChassisSpeeds(m_driveTrain.getSpeedsMetersPerSecond()).vxMetersPerSecond));
    }
...
//    }
    ...
    public void end(boolean interrupted) {
        ...
        SmartDashboard.putBoolean("DriveTrain isRunning", false);
    }
}
