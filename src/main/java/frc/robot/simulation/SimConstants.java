...
public class SimConstants {
    public static final double fieldWidthMeters = 15.980;
    public static final double fieldHieghtMeters = 8.210;
    public static final double ballDiameterMeters = 0.1778;
